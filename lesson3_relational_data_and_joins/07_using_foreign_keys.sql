...
INSERT INTO
  "reviews" (product_id, content_body)
VALUES
  (1, 'a little small'),
  (1, 'very round!'),
  (2, 'could have been smaller');

-- To reiterate, foreign key constraints do not prevent NULL values from being
-- inserted into the constrained foreign key column, which is sometimes
-- desirable.